...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton fabAddLista;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnLogout,
      @NonNull TextInputEditText edtSearch, @NonNull FloatingActionButton fabAddLista,
      @NonNull RecyclerView recyclerView, @NonNull TextInputLayout textInputLayoutSearch) {
    this.rootView = rootView;
    this.btnLogout = btnLogout;
    this.edtSearch = edtSearch;
    this.fabAddLista = fabAddLista;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.fabAddLista;
      FloatingActionButton fabAddLista = ViewBindings.findChildViewById(rootView, id);
      if (fabAddLista == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnLogout, edtSearch, fabAddLista,
          recyclerView, textInputLayoutSearch);
    }
